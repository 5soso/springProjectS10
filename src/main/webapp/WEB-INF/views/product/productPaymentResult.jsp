...
<head>
  <meta charset="UTF-8">
  <title>productPaymentResult.jsp</title>
...
<div class="container" style="margin-top: 130px;">
    ...
    <c:forEach var="vo" items="${orderVOS}">
      <tr>
        <td style="text-align:center;">
        	...
        	<img src="${ctp}/product/${imgs[0]}" width="100px"/>
        </td>
  ...
  <hr/>
  <p class="text-center">
    <a href="${ctp}/product/productList" class="btn btn-success">계속쇼핑하기</a> &nbsp;
    <a href="${ctp}/product/productMyOrder" class="btn btn-primary">구매내역보기</a>
  </p>
  <hr/>
</div>
<br/>

...
<head>
  ...
  <script>
    ...
    function answerCheck() {
    	...
    	tempStr += '<input type="hidden" name="part" value="${vo.part}"/>';
			$("#reply").html(tempStr);
    }
...
<div class="container w3-main" style="margin-left:500px;margin-top:43px;">
  <p><br/></p>
  <h2 class="text-center">문의글 내용조회</h2>
  <br/>
  <table class="table table-bordered">
    ...
    <tr>
      <td colspan="4" style="text-align:center;">
        ...
        <c:if test="${sName eq vo.nickName}">
          <c:if test="${vo.qnaSw == 'q'}">
        ...
        <input type="button" value="돌아가기" onclick="location.href='adminQnaList?pag=${pag}&pageSize=${pageSize}';" class="btn btn-secondary"/>
      </td>
    </tr>
  </table>
